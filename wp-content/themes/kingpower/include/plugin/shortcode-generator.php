<?php
	...
	function gdl_acc_item_shortcode( $atts, $content = null ){
		...
		$acc_item = $acc_item . "<div class='accordion-content'>" . gdlr_shortcode_content_filter($content) . "</div>";
	...
	function gdl_column_shortcode( $atts, $content = null ){
		...
		return '<div class="shortcode' . str_replace('/', '-', $col) . ' ' . $last . '">' . gdlr_shortcode_content_filter($content) . '</div>' . $clear;
		switch($col){
			case '1/4': return '<div class="shortcode1-4 ' . $last . '">' . gdlr_shortcode_content_filter($content) . '</div>' . $clear;
			case '1/3': return '<div class="shortcode1-3 ' . $last . '">' . gdlr_shortcode_content_filter($content) . '</div>' . $clear;
			case '1/2': return '<div class="shortcode1-2 ' . $last . '">' . gdlr_shortcode_content_filter($content) . '</div>' . $clear;
			case '2/3': return '<div class="shortcode2-3 ' . $last . '">' . gdlr_shortcode_content_filter($content) . '</div>' . $clear;
			case '3/4': return '<div class="shortcode3-4 ' . $last . '">' . gdlr_shortcode_content_filter($content) . '</div>' . $clear;
			case '1/1': return '<div class="shortcode1">' . gdlr_shortcode_content_filter($content) . '</div>';				
			default : return;
		}			
	}	
	...
	function gdl_message_box_shortcode( $atts, $content = null ){
		...
		$message_box =  $message_box . '<div class="message-box-content">' . gdlr_shortcode_content_filter($content) . '</div>';
	...
	function gdl_social_shortcode( $atts, $content = null ){
		...
		$social = $social . '<img class="no-preload" src="' . GOODLAYERS_PATH . '/images/icon/social-icon-m/' . $type . '.png' . '" width="32" height="32" alt="' . $type . '"></a></div>';
		return $social;
	}
	...
	function gdl_tab_item_shortcode( $atts, $content = null ){
		...
		$gdl_tab_array[] = array("title" => $title , "content" => gdlr_shortcode_content_filter($content));
	}	
	...
	function gdl_toggle_item_shortcode( $atts, $content = null ){
		...
		$toggle_item = $toggle_item . "<div class='toggle-box-content'>" . gdlr_shortcode_content_filter($content) . "</div>";
