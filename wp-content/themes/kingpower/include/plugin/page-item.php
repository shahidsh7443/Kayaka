	...
	*/
	...
	function print_slider_item($item_xml){
		...
		if( $xml_size == 'full-width' ){
			echo '<div class="gdl-slider-wrapper fullwidth"><div class="animatedParent"><div id="ytube" class="animated growIn slower"><iframe width="460" height="315" src="https://www.youtube.com/embed/_UbDeqPdUek" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div></div>';
		}else{
