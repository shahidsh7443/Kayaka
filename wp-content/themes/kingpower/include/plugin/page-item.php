	...
	*/
	...
	function print_slider_item($item_xml){
		...
		if( $xml_size == 'full-width' ){
			echo '<div class="gdl-slider-wrapper fullwidth"><div id="ytube" class="animatedParent"><iframe class="animated growIn slower" width="460" height="315" src="https://www.youtube.com/embed/2fz7b5Q-UgU?wmode=opaque" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>';
		}else{
