	...
	*/
	...
	$goodlayers_menu = array(			
		...
		__('Overall Elements', 'gdl_back_office') => array(
			...
			__('Page Title Background', 'gdl_back_office')=>'gdl_panel_header_background',
		...
		__('Elements Color', 'gdl_back_office') => array(
			...
			__('Sidebar / Footer Gallery', 'gdl_back_office')=>'gdl_panel_sidebar_color',
	...
	$goodlayers_element = array(
		...
		'gdl_panel_font_size' => array(
			...
			__('WIDGET TITLE SIZE', 'gdl_back_office')=>array('type'=>'sliderbar','name'=>THEME_SHORT_NAME.'_widget_title_size','default'=>'17',
		...
		'gdl_panel_logo' => array( 
			...
			__('NAVIGATION TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_navigation_top_margin','default'=>'35'),		
			__('FULL SLIDER CONTENT MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_full_slider_content_margin','default'=>'-130',
				'description'=>'this margin attribute use to make full top slider overlap with the content area in desktop view. ( wider than 1240px ) '),		
		),
		...
		'gdl_panel_header_background' => array(
			...
			__('DEFAULT TITLE BACKGROUND (PREDEFINED)','gdl_back_office')=>array(
				'type'=>'radioimage',
				'name'=>THEME_SHORT_NAME.'_default_title_background_predefined',
				'default'=>'1t',
				'options'=>array(
					'1'=>array('value'=>'1t','image'=>'/include/images/title-background/title-bg-1t.jpg'),
					'2'=>array('value'=>'2t','image'=>'/include/images/title-background/title-bg-2t.jpg'),
					'3'=>array('value'=>'3t','image'=>'/include/images/title-background/title-bg-3t.jpg'),
					'4'=>array('value'=>'4t','image'=>'/include/images/title-background/title-bg-4t.jpg'),
					'5'=>array('value'=>'5t','image'=>'/include/images/title-background/title-bg-5t.jpg'),
					'6'=>array('value'=>'6t','image'=>'/include/images/title-background/title-bg-6t.jpg')
				)
			),			
		...
		'gdl_panel_top_navigation' => array(
			__('TOP NAVIGATION LEFT TEXT', 'gdl_back_office')=>array('type'=>'textarea','name'=>THEME_SHORT_NAME.'_top_navigation_left'),			
			__('TOP NAVIGATION RIGHT TEXT', 'gdl_back_office')=>array('type'=>'textarea','name'=>THEME_SHORT_NAME.'_top_navigation_right'),			
		),
		...
		'gdl_panel_icon_style' => array(
			__('SOCIAL ICON STYLE','gdl_back_office')=>array( 'type'=>'combobox', 'name'=>THEME_SHORT_NAME.'_social_icon_type', 'options'=>array('1'=>'light','2'=>'dark')),		
		...
		'gdl_panel_copyright_area' => array( 
			__('SHOW FOOTER GALLERY', 'gdl_back_office')=>array('type'=>'radioenabled', 'name'=> THEME_SHORT_NAME.'_show_footer_gallery', 'default'=>'disable'),		
			__('SHOW FOOTER GALLERY ONLY HOMEPAGE', 'gdl_back_office')=>array('type'=>'radioenabled', 'name'=> THEME_SHORT_NAME.'_show_footer_gallery_only_homepage', 'default'=>'disable'),	
			__('FOOTER GALLERY ID', 'gdl_back_office')=>array('type'=>'combobox', 'name'=> THEME_SHORT_NAME.'_footer_gallery_id', 'options'=>get_post_slug_list('gdl-gallery')),		
			__('FOOTER GALLERY TITLE', 'gdl_back_office')=>array('type'=>'inputtext', 'name'=> THEME_SHORT_NAME.'_footer_gallery_title', 'default'=>'Our Clients'),		
		...
		'gdl_panel_header_navigation' => array(
			...
			__('TOP BAR BACKGROUND', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_bar_background',
				'default'=>'#f16236', 'attr'=> array('background-color'), 'selector'=>'.top-navigation-wrapper' ),
			__('SEARCH TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_search_text',
				'default'=>'#ffffff', 'attr'=> array('color'), 'selector'=>'div.page-header-wrapper input[type="text"]' ),
			__('SEARCH TEXT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_search_background',
				'default'=>'#0a0a0a', 'attr'=> array('background-color'), 'selector'=>'div.page-header-wrapper input[type="text"]' ),		
			__('MAIN NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text',
				'default'=>'#000000', 'attr'=> array('color'), 'selector'=>'.sf-menu li a',
				'description'=>'This is the text color of the main navigation in the normal state.'),
			__('MAIN NAVIGATION DESCRIPTION', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_description',
				'default'=>'#969696', 'attr'=> array('color'), 'selector'=>'.sf-menu li span.gdl-description',
				'description'=>'This is the text color of the main navigation in the normal state.'),				
			__('MAIN NAVIGATION TEXT HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_hover',
				'default'=>'#000000', 'attr'=> array('color'),  'selector'=>'.sf-menu li a:hover',
			...
			__('MAIN NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_current',
				'default'=>'#000000', 'attr'=> array('color'), 'selector'=>'.sf-menu > li.current-menu-ancestor > a, .sf-menu > li.current-menu-item > a, .sf-menu > li.current-post-ancestor > a',
			...
			__('SUB NAVIGATION TEXT HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text_hover',
				'default'=>'#b5b5b5', 'attr'=> array('color'), 
				'selector'=>'.sf-menu li li > a:hover' ),
			__('SUB NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text_current',
				'default'=>'#b5b5b5', 'attr'=> array('color'), 
				'selector'=>'.sf-menu li li.current-menu-item > a, .sf-menu li li.current-menu-ancestor > a, .sf-menu li li.current-post-ancestor > a' ),
		),		
		...
		'gdl_panel_body' => array(	
			...
			__('PAGE HEADER LEFT BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_left_bar',
				'default'=>'#f16337', 'attr'=>array('background-color'), 'selector'=>'div.page-header-left-bar, div.portfolio-filer-left-bar '),	
			__('PAGE HEADER CAPTION', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_caption',
				'default'=>'#e2e2e2', 'attr'=>array('color'), 'selector'=>'span.page-header-caption'),				
			__('ITEM HEADER TITLE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_item_header_title',
				'default'=>'#111111', 'attr'=>array('color'), 'selector'=>'h3.gdl-header-title'),	
			__('ITEM HEADER LEFT BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_item_header_left_bar',
				'default'=>'#f16337', 'attr'=>array('background-color'), 'selector'=>'div.gdl-header-left-bar, .gdl-sidebar-left-bar'),					
			...
			__('BODY BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_body_background',
				'default'=>'#ededed', 'attr'=>array('background-color'), 'selector'=>'html',
			...
			__('LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_color',
				'default'=>'#ea6315', 'attr'=>array('color'), 'selector'=>'a',
			...
			__('LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_hover_color',
				'default'=>'#ea8e59', 'attr'=>array('color'), 'selector'=>'a:hover',
		...
		'gdl_panel_sidebar_color' => array(
			__('SIDEBAR LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_link_color',
				'default'=>'#595959', 'attr'=>array('color'), 'selector'=>'.sidebar-wrapper a' ),
			__('SIDEBAR LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_link_hover_color',
				'default'=>'#999999', 'attr'=>array('color'), 'selector'=>'.sidebar-wrapper a:hover' ),
			...
			__('FOOTER GALLERY TITLE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_gallery_title_color',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'div.footer-gallery-wrapper .footer-gallery-title' ),		
			__('FOOTER GALLERY NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_gallery_navigation_background',
				'default'=>'#3a3a3a', 'attr'=>array('background-color'), 'selector'=>'div.footer-gallery-wrapper .footer-gallery-nav-right, div.footer-gallery-wrapper .footer-gallery-nav-left' ),						
			__('FOOTER GALLERY BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_gallery_background',
				'default'=>'#222222', 'attr'=>array('background-color'), 'selector'=>'.footer-gallery-wrapper' ),				
		),
		...
		'gdl_panel_footer' => array(	
			__('FOOTER LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_color',
				'default'=>'#ededed', 'attr'=>array('color'), 'selector'=>'.footer-wrapper a', 
			...
			__('FOOTER LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_hover_color',
				'default'=>'#a8a8a8', 'attr'=>array('color'), 'selector'=>'.footer-wrapper a:hover', 
			...
			__('FOOTER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_background',
				'default'=>'#2b2b2b', 'attr'=>array('background-color'), 'selector'=>'div.footer-wrapper'),
			...
			__('FOOTER INPUT BOX TEXT', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_text', 
				'default'=>'#adadad', 'attr'=>array('color'), 
			...
			__('FOOTER BUTTON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_button_color', 
				'default'=>'#141414', 'attr'=>array('background-color'), 'selector'=>'.footer-wrapper .contact-form-wrapper button',
			...
			__('FOOTER TAG CLOUD BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_tagcloud_background', 
				'default'=>'#191919', 'attr'=>array('background-color'), 'selector'=>'div.footer-wrapper .tagcloud a'),
			...
			__('COPYRIGHT BORDER TOP LINE', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_copyright_top_border', 
				'default'=>'#060606', 'attr'=>array('border-top-color'), 'selector'=>'div.footer-wrapper .copyright-border'),
			__('COPYRIGHT BORDER BOTTOM LINE', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_copyright_bottom_border', 
				'default'=>'#3e3e3e', 'attr'=>array('border-bottom-color'), 'selector'=>'div.footer-wrapper .copyright-border'),				
		...
		'gdl_panel_slider' => array(
			__('SLIDER TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_title_color',
				'default'=>'#f16236', 'attr'=>array('color'), 'selector'=>'h2.gdl-slider-title' ),
			__('SLIDER TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_title_background',
				'default'=>'#ffffff', 'attr'=>array('background-color'), 'selector'=>'h2.gdl-slider-title'),
			...
			__('SLIDER CAPTION BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_caption_border',
				'default'=>'#f16236', 'attr'=>array('border-color'), 'selector'=>'div.gdl-slider-caption'),								
			__('SLIDER BULLET COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_bullet_color',
				...
				'selector'=>'.ls-kingpower .ls-bottom-slidebuttons a, .flex-control-nav li a, .nivo-controlNav a, div.anythingSlider .anythingControls ul a'),
			__('SLIDER BULLET ACTIVE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_bullet_active',
				...
				'selector'=>'.ls-kingpower .ls-bottom-slidebuttons a.ls-nav-active, .ls-kingpower .ls-bottom-slidebuttons a:hover' . 
			...
			__('SLIDER NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_navigation_background',
				'default'=>'#f16236', 'attr'=>array('background-color'), 
				'selector'=>'.ls-kingpower .ls-nav-prev, .ls-kingpower .ls-nav-next,' . 
			...
			__('UNDER SLIDER BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_under_slider_background',
				'default'=>'#f16337', 'attr'=>array('background-color'), 'selector'=>'.bottom-slider-wrapper'),	
			...
			__('STUNNING TEXT CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_caption_color',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'.stunning-text-caption'),
			__('STUNNING TEXT BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_background_color',
				'default'=>'#434343', 'attr'=>array('background-color'), 'selector'=>'.stunning-text-wrapper'),	
			__('STUNNING TEXT TOP BORDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_top_border',
				'default'=>'#f16337', 'attr'=>array('border-color'), 'selector'=>'.stunning-text-wrapper'),					
		),
		...
		'gdl_panel_blog_pagination' => array(			
			...
			__('BLOG INFO TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_color',
				'default'=>'#787878', 'attr'=>array('color'), 'selector'=>'div.blog-info-wrapper, div.blog-info-wrapper a, ' . 
			...
			__('BLOG INFO BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_background',
				'default'=>'#f8f8f8', 'attr'=>array('background-color'), 'selector'=>'div.gdl-blog-full .blog-info-wrapper, div.gdl-blog-medium .blog-info-wrapper'),		
			__('BLOG WIDGET INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_widget_info_color',
				'default'=>'#3a3a3a', 'attr'=>array('color'), 'selector'=>'div.gdl-blog-widget div.blog-info-wrapper, div.gdl-blog-widget div.blog-info-wrapper a'),					
			...
			__('PAGINATION HOVER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_hover_background',
				'default'=>'#f16236', 'attr'=>array('background-color'), 'selector'=>'div.gdl-pagination a:hover'),
			...
			__('PAGINATION CURRENT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_current_background',
				'default'=>'#f16236', 'attr'=>array('background-color'), 'selector'=>'div.gdl-pagination span'),
		...
		'gdl_panel_portfolio' => array(
			__('THUMBNAIL HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_thumbnail_hover_color',
				'default'=>'#f16236', 'attr'=>array('background-color'), 'selector'=>'div.portfolio-media-wrapper span.portfolio-thumbnail-image-hover'),		
			...
			__('PORT TITLE BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_border',
				'default'=>'#e4e4e4', 'attr'=>array('border-color'), 'selector'=>'.portfolio-item .portfolio-context'),
			...
			__('PORT TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_color',
				'default'=>'#393939', 'attr'=>array('color'), 'selector'=>'.portfolio-item .portfolio-context .portfolio-title a',
			...
			__('PORT TAG COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_tag_color',
				'default'=>'#aaaaaa', 'attr'=>array('color'), 'selector'=>'.portfolio-item .portfolio-context .portfolio-tag a, .portfolio-item .portfolio-context .portfolio-tag'),	
			__('PORT TAG HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_tag_color',
				'default'=>'#aaaaaa', 'attr'=>array('color'), 'selector'=>'.portfolio-item .portfolio-context:hover .portfolio-tag a, .portfolio-item .portfolio-context:hover .portfolio-tag'),				
			...
			__('PORT NAV BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_carousel_nav_border',
				'default'=>'#e3e3e3', 'attr'=>array('border-color'), 
		...
		'gdl_panel_price_personnal_item' => array(
			...
			__('PRICE TAG ACTIVE BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_tag_active_background', 
				'default'=>'#f16236', 'attr'=>array('background-color'), 'selector'=>'div.best-price .price-tag'),
			__('PRICE ACTIVE TOP BORDER', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_active_border', 
				'default'=>'#f16236', 'attr'=>array('border-top-color', 'border-bottom-color'), 'selector'=>'div.best-active'),			
			__('PRICE ACTIVE BUTTON BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_active_button_background', 
				'default'=>'#f16236', 'attr'=>array('background-color'), 'selector'=>'div.price-item .price-button'),				
			...
			__('PERSONNAL THUMBNAIL BORDER', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_thumbnail_border', 
				'default'=>'#f16236', 'attr'=>array('border-color'), 'selector'=>'div.personnal-item .personnal-thumbnail'),
		...
		'gdl_panel_additional_elements' => array(				
			__('ACCORDION TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_accordion_title',
				'default'=>'#111111', 'attr'=>array('color'), 'selector'=>'ul.gdl-accordion li .accordion-title, ul.gdl-toggle-box li .toggle-box-title'),		
			__('ACCORDION TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_accordion_title_background',
				'default'=>'#eaeaea', 'attr'=>array('background-color'), 'selector'=>'ul.gdl-accordion li .accordion-title, ul.gdl-toggle-box li .toggle-box-title'),
			...
			__('BUTTON BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_background_color',
				'default'=>'#e1e1e1', 'attr'=>array('background-color'), 'selector'=>'a.gdl-button, body button, input[type="submit"], input[type="reset"], input[type="button"]'),					
			__('BUTTON TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_text_color',
				'default'=>'#5e5e5e', 'attr'=>array('color'), 'selector'=>'a.gdl-button, body button, input[type="submit"], input[type="reset"], input[type="button"]'),			
			...
			__('FEATURE MEDIA BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_feature_media_background',
				'default'=>'#f4f4f4', 'attr'=>array('background-color'), 'selector'=>'div.featured-media-wrapper'),
			__('FEATURE MEDIA ICON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_feature_media_icon_background',
				'default'=>'#f16337', 'attr'=>array('background-color'), 'selector'=>'div.featured-media-wrapper .featured-media-header-icon, div.featured-media-left-bar'),				
			__('FEATURE MEDIA TITLE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_feature_media_title',
				'default'=>'#111111', 'attr'=>array('color'), 'selector'=>'div.featured-media-wrapper .featured-media-title'),	
			__('FEATURE MEDIA CAPTION', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_feature_media_caption',
				'default'=>'#808080', 'attr'=>array('color'), 'selector'=>'div.featured-media-wrapper .featured-media-caption'),		
			__('FEATURE MEDIA CONTENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_feature_media_content',
				'default'=>'#4d4d4d', 'attr'=>array('color'), 'selector'=>'div.featured-media-wrapper'),	
			__('FEATURE MEDIA BUTTON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_feature_media_button_background',
				'default'=>'#d3d3d3', 'attr'=>array('background-color'), 'selector'=>'div.featured-media-wrapper .gdl-button'),
			__('FEATURE MEDIA BUTTON TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_feature_media_button_text',
				'default'=>'#5e5e5e', 'attr'=>array('color'), 'selector'=>'div.featured-media-wrapper .gdl-button'),					
		),
		...
		'gdl_panel_additional_elements_2' => array(		
			...
			__('TAB ACTIVE TITLE BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_active_title_border',
				'default'=>'#f16236', 'attr'=>array('border-top-color'), 'selector'=>'div.gdl-tab ul.gdl-tab-title li a.active' ),	
			...
			__('TESTIMONIAL (SLIDE) BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_slide_background',
				'default'=>'#eaeaea', 'attr'=>array('background-color'), 'selector'=>'div.gdl-carousel-testimonial .testimonial-content'),	
