...
jQuery(document).ready(function(){ 
	...
	var DIV_SIZE = [
		['1/4','element1-4',1/4,['About-Us','Featured-Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog']],
		['1/3','element1-3',1/3,['About-Us','Featured-Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog']],
		['1/2','element1-2',1/2,['About-Us','Featured-Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog']],
		['2/3','element2-3',2/3,['About-Us','Featured-Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog']],
		['3/4','element3-4',3/4,['About-Us','Featured-Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog']],
		['1/1','element1-1',1  ,['About-Us','Featured-Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog','Stunning-Text','Contact-Form']]
	];
	...
	jQuery('select#page-option-top-slider-types').change(function(){
		if(jQuery(this).val()=='None' || jQuery(this).val()=='Title'){
			...
			jQuery(this).parents('.meta-body').siblings('#gdl-bottom-slider-wrapper').slideUp();
		}else if(jQuery(this).val()=='Layer Slider'){
			jQuery(this).parents('.meta-body').siblings('#gdl-top-slider-wrapper').slideUp();
			jQuery(this).parents('.meta-body').siblings('#gdl-layer-slider-wrapper').slideDown();
			jQuery(this).parents('.meta-body').siblings('#gdl-bottom-slider-wrapper').slideDown();
		}else{
	...
	jQuery('select#page-option-top-slider-types').each(function(){
		if(jQuery(this).val()=='None' || jQuery(this).val()=='Title'){
			...
			jQuery(this).parents('.meta-body').siblings('#gdl-bottom-slider-wrapper').css('display','none');
		}else if(jQuery(this).val()=='Layer Slider'){
			jQuery(this).parents('.meta-body').siblings('#gdl-top-slider-wrapper').css('display','none');
			jQuery(this).parents('.meta-body').siblings('#gdl-layer-slider-wrapper').css('display','block');
			jQuery(this).parents('.meta-body').siblings('#gdl-bottom-slider-wrapper').css('display','block');
		}else{
