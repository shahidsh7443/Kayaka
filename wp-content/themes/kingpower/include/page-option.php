<?php 
	...
	*/
	...
	$page_meta_boxes = array(
			...
			'name'=>array(
				...
				'About-Us' =>array(
					'header'=>array(
						...
						'name'=> 'page-option-item-about-us-header-title',
						'type'=> 'inputtext'),
					'image'=>array(
						'title'=> 'IMAGE',
						'name'=> 'page-option-item-about-us-image',
						'type'=> 'upload'),				
					'content'=>array(
						'title'=> __('CONTENT', 'gdl_back_office'),
						'name'=> 'page-option-item-about-us-content',
						'type'=> 'textarea'),
					'button-text'=>array(
						'title'=> __('BUTTON TEXT', 'gdl_back_office'),
						'name'=> 'page-option-item-about-us-button-text',
						'default'=> 'Download PDF file',
						'type'=> 'inputtext'),
					'button-link'=>array(
						'title'=> __('BUTTON LINK', 'gdl_back_office'),
						'name'=> 'page-option-item-about-us-button-link',
						'type'=> 'inputtext'),		
					'enable-pdf'=>array(
						'title'=> __('ENALBE PDF ICON', 'gdl_back_office'),
						'name'=> 'page-option-item-enable-pdf-icon',
						'type'=> 'combobox',
						'options'=> array('Yes', 'No')),						
					'item-margin'=>array(
						'title'=> __('BOTTOM MARGIN', 'gdl_back_office'),
						'name'=> 'page-option-item-about-us-item-margin',
						'default'=>'40',
						'hr'=>'none',
						'type'=> 'inputtext'),						
				),
				...
				'Column-Service'=>array(
					'icon-class'=>array(
						...
						'description'=> 'Input some class to use the predefined icon, uploading the image to below field will ignore this value.<br><br>' .
							'You can see the list of all item class here http://themes.goodlayers2.com/kingpower/icon/' ),					
					'icon'=>array(
						'title'=> 'ICON',
				...
				'Featured-Media' =>array(
					'header-icon'=>array(
						'title'=> __('HEADER ICON CLASS', 'gdl_back_office'),
						'name'=> 'page-option-item-featured-media-header-icon-class',
						'type'=> 'inputtext',
						'description'=> 'You can see the list of all item class here http://themes.goodlayers2.com/kingpower/icon/'),		
					'title'=>array(
						'title'=> __('TITLE', 'gdl_back_office'),
						'name'=> 'page-option-item-featured-media-title',
						'type'=> 'inputtext'),		
					'type'=>array(
						'title'=>'MEDIA TYPE',
					...
					'caption'=>array(
						'title'=> __('TITLE', 'gdl_back_office'),
						'name'=> 'page-option-item-featured-media-caption',
						'type'=> 'inputtext'),							
					'content'=>array(
						'title'=> __('CONTENT', 'gdl_back_office'),
						'name'=> 'page-option-item-featured-media-content',
						'type'=> 'textarea'),
					'button-text'=>array(
						'title'=> __('BUTTON TEXT', 'gdl_back_office'),
						'name'=> 'page-option-item-featured-media-button-text',
						'default'=> 'Learn More',
						'type'=> 'inputtext'),
					'button-link'=>array(
						'title'=> __('BUTTON LINK', 'gdl_back_office'),
						'name'=> 'page-option-item-featured-media-button-link',
						'type'=> 'inputtext'),	
					'social'=>array(
						'title'=> __('SOCIAL SHORTCODE AREA', 'gdl_back_office'),
						'name'=> 'page-option-item-featured-media-social-shortcode',
						'type'=> 'textarea',
						'hr'=> 'none'),		
					'item-margin'=>array(
						'title'=> __('BOTTOM MARGIN', 'gdl_back_office'),
						'name'=> 'page-option-item-featured-media-item-margin',
						'default'=>'40',
						'hr'=>'none',
						'type'=> 'inputtext'),						
				),				
		...
		"Enable Full Slider" => array(
			'title'=> __('ENABLE FULL SLIDER', 'gdl_back_office'),
			'name'=>'page-option-enable-full-slider',
			'options'=>array('Yes', 'No'),
			'type'=>'combobox',
			'description'=>'*** Enable this option will force the slider to be full width ( acrosse the page ). <br><br>' . 
				'If boxed style is enabled ( at the admin panel > general > page setting ), the content area and header area will be overlapped with the slider area like the homepage of our demo site.'
		),
		
		"Bottom Slider Column" => array(
			'title'=> __('UNDER SLIDER COLUMN NUMBER', 'gdl_back_office'),
			'name'=>'page-option-bottom-slider-column',
			'options'=>array('None', '1', '2', '3', '4'),
			'type'=>'combobox',
			'hr'=>'none',
			'description'=>'Please ignore the column 2 3 and 4 if you select the column number to 1'
		),	

		"Bottom Slider Column 1" => array(
			'title'=> __('UNDER SLIDER COLUMN 1', 'gdl_back_office'),
			'name'=>'page-option-bottom-slider-column1',
			'type'=>'textarea',
			'default'=>'[column_service background_color="#f16236" color="#ffffff" head_image="IMAGE_URL" head_image_width="" title="TITLE" ]CONTENT[/column_service]',
			'hr'=>'none'
		),		
		
		"Bottom Slider Column 2" => array(
			'title'=> __('UNDER SLIDER COLUMN 2', 'gdl_back_office'),
			'name'=>'page-option-bottom-slider-column2',
			'type'=>'textarea',
			'default'=>'[column_service background_color="#f2714a" color="#ffffff" head_image="IMAGE_URL" head_image_width="" title="TITLE" ]CONTENT[/column_service]',
			'hr'=>'none'
		),	

		"Bottom Slider Column 3" => array(
			'title'=> __('UNDER SLIDER COLUMN 3', 'gdl_back_office'),
			'name'=>'page-option-bottom-slider-column3',
			'type'=>'textarea',
			'default'=>'[column_service background_color="#f4815e" color="#ffffff" head_image="IMAGE_URL" head_image_width="" title="TITLE" ]CONTENT[/column_service]',
			'hr'=>'none'
		),	

		"Bottom Slider Column 4" => array(
			'title'=> __('UNDER SLIDER COLUMN 4', 'gdl_back_office'),
			'name'=>'page-option-bottom-slider-column4',
			'type'=>'textarea',
			'default'=>'[column_service background_color="#f59172" color="#ffffff" head_image="IMAGE_URL" head_image_width="" title="TITLE" ]CONTENT[/column_service]',
			'hr'=>'none'
		),			
