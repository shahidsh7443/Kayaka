<?php
	...
	*/
	...
	if (function_exists('register_sidebar')){	
		...
		$sidebar_attr['before_title'] = '<div class="custom-sidebar-title-wrapper"><div class="gdl-sidebar-left-bar"></div><div class="gdl-sidebar-left-bar"></div><h3 class="custom-sidebar-title gdl-border-x bottom">';
		$sidebar_attr['after_title'] = '</h3><div class="custom-sidebar-title-gimmick"></div><div class="clear"></div></div>';		
